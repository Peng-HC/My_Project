...
{
    std::cout << "mqttclient:MQTTClient_connect" << std::endl;
	MQTTClients* m = handle;
	MQTTResponse response;
    std::cout << "mqttclient:MQTTClient_connect2" << std::endl;
	if (m->c->MQTTVersion >= MQTTVERSION_5)
		return MQTTCLIENT_WRONG_MQTT_VERSION;
    std::cout << "mqttclient:MQTTClient_connect3" << std::endl;
	response = MQTTClient_connectAll(handle, options, NULL, NULL);
    std::cout << "mqttclient:MQTTClient_connect4" << std::endl;
