...
char	testNames[NUMOFTESTS+1][32] = { " ", "Frequency", "BlockFrequency", "Poker", "Serial", "Runs", "RunsFrequency", "LongestRun", "BinaryDerivation", "AutoCorrelation", "Rank",
			"CumulativeSums", "ApproximateEntropy", "LinearComplexity", "Universal", "FFT"};
